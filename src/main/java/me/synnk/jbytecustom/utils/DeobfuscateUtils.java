package me.synnk.jbytecustom.utils;
...
public class DeobfuscateUtils {
    ...
    public static void fixSignature(Map<String, ClassNode> classes){
        classes.values().forEach(DeobfuscateUtils::fixSignature);
    }
    ...
    public static void removeLineNumber(Map<String, ClassNode> classes){
        classes.values().forEach(DeobfuscateUtils::removeLineNumber);
    }
    ...
    public static void removeLocalVariable(Map<String, ClassNode> classes) {
        classes.values().forEach(DeobfuscateUtils::removeLocalVariable);
    }
    ...
    public static void removeSyntheticBridge(Map<String, ClassNode> classes){
        classes.values().forEach(DeobfuscateUtils::removeSyntheticBridge);
    }
    ...
    public static void removeIllegalVarargs(Map<String, ClassNode> classes){
        classes.values().forEach(DeobfuscateUtils::removeIllegalVarargs);
    }
...
//                                now.index = oldindex;
    ...
    public static void removeIllegalInvisibleAnnotations(Map<String, ClassNode> classes){
        classes.values().forEach(DeobfuscateUtils::removeIllegalInvisibleAnnotations);
    }
