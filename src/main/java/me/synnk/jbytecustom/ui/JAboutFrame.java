...
public class JAboutFrame extends JDialog {
    ...
    public JAboutFrame(JByteCustom jbm) {
        this.setTitle(JByteCustom.res.getResource("about") + " " + jbm.getTitle());
        this.setModal(true);
        ...
        setResizable(false);
        JButton close = new JButton(JByteCustom.res.getResource("close"));
        ...
        title.setFont(font);
        title.setText(TextUtils.toLight("JByteCustom " + JByteCustom.version + " - by SynnK & JohnShiozo") + "<br>Reborn by Panda,<br> Remastered by xBrownieCodez,<br> Customized by " + TextUtils.toBold("SynnK") + ", libs containment by JohnShiozo<br>");
